...
@section('content')
<div class="mb-4">
    <h1 class="h3 fw-bold text-dark">Create Service Type</h1>
</div>
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <select name="form_section" id="form_section" class="form-select" required>
                        <option value="project_based" {{ old('form_section') == 'project_based' ? 'selected' : '' }}>Project Based</option>
                        <option value="domain_hosting" {{ old('form_section') == 'domain_hosting' ? 'selected' : '' }}>Domain & Hosting</option>
                        <option value="custom" {{ old('form_section') == 'custom' ? 'selected' : '' }}>Custom</option>
                    </select>
